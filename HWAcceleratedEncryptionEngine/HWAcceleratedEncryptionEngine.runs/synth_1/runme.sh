...
HD_PWD='/home/tjlw/HWAcceleratedEncryptionEngine/HWAcceleratedEncryptionEngine.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log EncryptionSubsystem_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source EncryptionSubsystem_wrapper.tcl
